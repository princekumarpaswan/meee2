...
// Draw the chart and set the chart values
  ...
  function drawChart() {
    ...
    if (window > 550) {
      const smallSc = document.getElementById("smallSc")
      smallSc.classList.add("hidden")
        var options = {'title':'Average exports per month from june 2022 to march 2023', 'width':955, 'height':446};
